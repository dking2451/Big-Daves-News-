        ...
        NavigationStack {
            List {
                Section("How to Use the App") {
                    ...
                    Label("Watch: next to the title — My List (bookmark), Filters, and Watch guide (info). Save, watch progress, and thumbs on each card tune recommendations.", systemImage: "play.tv")
